...
export MASTER_PORT="60148"
export WANDB_PROJECT="unimmv2x-h200-spd"
export WANDB_NAME="unimmv2x_coop_stg2_h200_g23_b1a4_r47_20260709_2127"
...
echo "[START] $(date -Is) run=unimmv2x_coop_stg2_h200_g23_b1a4_r47_20260709_2127 host=$(hostname) cuda=${CUDA_VISIBLE_DEVICES}"
echo "[INFO] resume from epoch_17 after quota cleanup; continue HF path checkpoints/unimmv2x_coop_stg2_h200_g23_b1a4_r46_20260708_1909"
