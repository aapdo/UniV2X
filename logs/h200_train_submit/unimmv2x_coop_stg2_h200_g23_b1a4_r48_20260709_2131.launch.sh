...
export MASTER_PORT="60149"
export WANDB_PROJECT="unimmv2x-h200-spd"
export WANDB_NAME="unimmv2x_coop_stg2_h200_g23_b1a4_r48_20260709_2131"
...
echo "[START] $(date -Is) run=unimmv2x_coop_stg2_h200_g23_b1a4_r48_20260709_2131 host=$(hostname) cuda=${CUDA_VISIBLE_DEVICES}"
echo "[INFO] resume from epoch_17 after killing stale r46 workers and quota cleanup; continue HF path checkpoints/unimmv2x_coop_stg2_h200_g23_b1a4_r46_20260708_1909"
