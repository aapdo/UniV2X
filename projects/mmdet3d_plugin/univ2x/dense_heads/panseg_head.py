...
class PansegformerHead(SegDETRHead):
    ...
    def forward_test(self,
        ...
        ## UniV2X: other_lane_query
        univ2x_lane_save_data = None
        if not self.is_ego_agent and self.return_lane_query:
            ...
            univ2x_lane_query_data = {'outputs_classes': pred_seg_dict['outputs_classes'],
        ...
        if not self.is_ego_agent and self.return_lane_query:
            bbox_list[0]['univ2x_lane_query_data'] = univ2x_lane_query_data
    ...
    def forward_train(self,
        ...
        if not self.is_ego_agent and self.return_lane_query:
            ...
            univ2x_lane_query_data = {'outputs_classes': pred_seg_dict['outputs_classes'],
                        ...
                        'query_pos': query_pos,
                        'reference': pred_seg_dict['reference']}
            pred_seg_dict['univ2x_lane_query_data'] = univ2x_lane_query_data
